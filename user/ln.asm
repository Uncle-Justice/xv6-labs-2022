...
main(int argc, char *argv[])
{
  ...
  50:	80c58593          	addi	a1,a1,-2036 # 858 <malloc+0x106>
  54:	4509                	li	a0,2
  56:	00000097          	auipc	ra,0x0
  5a:	60e080e7          	jalr	1550(ra) # 664 <fprintf>
...
gets(char *buf, int max)
{
 ...
 16a:	0344d863          	ble	s4,s1,19a <gets+0x56>
    cc = read(0, &c, 1);
 16e:	4605                	li	a2,1
...
atoi(const char *s)
{
 ...
 23a:	fee5f1e3          	bleu	a4,a1,21c <atoi+0x1e>
  return n;
}
 23e:	6422                	ld	s0,8(sp)
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 24c:	0800                	addi	s0,sp,16
  ...
  src = vsrc;
  if (src > dst) {
 24e:	02b57663          	bleu	a1,a0,27a <memmove+0x32>
    while(n-- > 0)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e8:	0080                	addi	s0,sp,64
  ...
  neg = 0;
  if(sgn && xx < 0){
 3ea:	c299                	beqz	a3,3f0 <printint+0x14>
 3ec:	0005cd63          	bltz	a1,406 <printint+0x2a>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 3fc:	00000897          	auipc	a7,0x0
 400:	47488893          	addi	a7,a7,1140 # 870 <digits>
 404:	a801                	j	414 <printint+0x38>
    x = -xx;
 ...
 40c:	4305                	li	t1,1
    x = -xx;
 40e:	b7dd                	j	3f4 <printint+0x18>
  }while((x /= base) != 0);
 410:	85be                	mv	a1,a5
    buf[i++] = digits[x % base];
 412:	8836                	mv	a6,a3
 414:	0018069b          	addiw	a3,a6,1
 418:	02c5f7bb          	remuw	a5,a1,a2
 41c:	1782                	slli	a5,a5,0x20
 41e:	9381                	srli	a5,a5,0x20
 420:	97c6                	add	a5,a5,a7
 422:	0007c783          	lbu	a5,0(a5)
 426:	00f70023          	sb	a5,0(a4)
  }while((x /= base) != 0);
 42a:	0705                	addi	a4,a4,1
 42c:	02c5d7bb          	divuw	a5,a1,a2
 430:	fec5f0e3          	bleu	a2,a1,410 <printint+0x34>
  if(neg)
 434:	00030b63          	beqz	t1,44a <printint+0x6e>
    buf[i++] = '-';
 438:	fd040793          	addi	a5,s0,-48
 43c:	96be                	add	a3,a3,a5
 43e:	02d00793          	li	a5,45
 442:	fef68823          	sb	a5,-16(a3)
 446:	0028069b          	addiw	a3,a6,2

  while(--i >= 0)
 44a:	02d05963          	blez	a3,47c <printint+0xa0>
 44e:	89aa                	mv	s3,a0
 450:	fc040793          	addi	a5,s0,-64
 454:	00d784b3          	add	s1,a5,a3
 458:	fff78913          	addi	s2,a5,-1
 45c:	9936                	add	s2,s2,a3
 45e:	36fd                	addiw	a3,a3,-1
 460:	1682                	slli	a3,a3,0x20
 462:	9281                	srli	a3,a3,0x20
 464:	40d90933          	sub	s2,s2,a3
    putc(fd, buf[i]);
 468:	fff4c583          	lbu	a1,-1(s1)
 46c:	854e                	mv	a0,s3
 46e:	00000097          	auipc	ra,0x0
 472:	f4c080e7          	jalr	-180(ra) # 3ba <putc>
  while(--i >= 0)
 476:	14fd                	addi	s1,s1,-1
 478:	ff2498e3          	bne	s1,s2,468 <printint+0x8c>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ac:	18048d63          	beqz	s1,646 <vprintf+0x1bc>
 4b0:	8aaa                	mv	s5,a0
 4b2:	8b32                	mv	s6,a2
 4b4:	00158913          	addi	s2,a1,1
  state = 0;
 4b8:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
 ...
 4e0:	ede080e7          	jalr	-290(ra) # 3ba <putc>
 4e4:	a019                	j	4ea <vprintf+0x60>
    } else if(state == '%'){
 4e6:	01498f63          	beq	s3,s4,504 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
 4ea:	0905                	addi	s2,s2,1
 4ec:	fff94483          	lbu	s1,-1(s2)
 4f0:	14048b63          	beqz	s1,646 <vprintf+0x1bc>
    c = fmt[i] & 0xff;
 ...
 518:	0ce78563          	beq	a5,a4,5e2 <vprintf+0x158>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 520:	0ee78c63          	beq	a5,a4,618 <vprintf+0x18e>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
 524:	11478663          	beq	a5,s4,630 <vprintf+0x1a6>
        putc(fd, c);
      } else {
 ...
 530:	e8e080e7          	jalr	-370(ra) # 3ba <putc>
        putc(fd, c);
 534:	85a6                	mv	a1,s1
 536:	8556                	mv	a0,s5
 538:	00000097          	auipc	ra,0x0
 53c:	e82080e7          	jalr	-382(ra) # 3ba <putc>
      }
      state = 0;
 540:	4981                	li	s3,0
 ...
 572:	e6e080e7          	jalr	-402(ra) # 3dc <printint>
 576:	8b26                	mv	s6,s1
      state = 0;
 578:	4981                	li	s3,0
 ...
 58e:	e52080e7          	jalr	-430(ra) # 3dc <printint>
 592:	8b26                	mv	s6,s1
      state = 0;
 594:	4981                	li	s3,0
 ...
 5ae:	e10080e7          	jalr	-496(ra) # 3ba <putc>
  putc(fd, 'x');
 5b2:	85ea                	mv	a1,s10
 5b4:	8556                	mv	a0,s5
 5b6:	00000097          	auipc	ra,0x0
 5ba:	e04080e7          	jalr	-508(ra) # 3ba <putc>
 5be:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 5d0:	dee080e7          	jalr	-530(ra) # 3ba <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 5d4:	0992                	slli	s3,s3,0x4
 5d6:	34fd                	addiw	s1,s1,-1
 5d8:	f4e5                	bnez	s1,5c0 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
 5da:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 5de:	4981                	li	s3,0
 5e0:	b729                	j	4ea <vprintf+0x60>
        s = va_arg(ap, char*);
 5e2:	008b0993          	addi	s3,s6,8
 5e6:	000b3483          	ld	s1,0(s6)
        if(s == 0)
 5ea:	c085                	beqz	s1,60a <vprintf+0x180>
        while(*s != 0){
 5ec:	0004c583          	lbu	a1,0(s1)
 5f0:	c9a1                	beqz	a1,640 <vprintf+0x1b6>
          putc(fd, *s);
 5f2:	8556                	mv	a0,s5
 ...
 602:	f9e5                	bnez	a1,5f2 <vprintf+0x168>
        s = va_arg(ap, char*);
 604:	8b4e                	mv	s6,s3
      state = 0;
 606:	4981                	li	s3,0
 608:	b5cd                	j	4ea <vprintf+0x60>
          s = "(null)";
 60a:	00000497          	auipc	s1,0x0
 60e:	27e48493          	addi	s1,s1,638 # 888 <digits+0x18>
        while(*s != 0){
 612:	02800593          	li	a1,40
 616:	bff1                	j	5f2 <vprintf+0x168>
        putc(fd, va_arg(ap, uint));
 ...
 638:	d86080e7          	jalr	-634(ra) # 3ba <putc>
      state = 0;
 63c:	4981                	li	s3,0
 63e:	b575                	j	4ea <vprintf+0x60>
        s = va_arg(ap, char*);
 640:	8b4e                	mv	s6,s3
      state = 0;
 642:	4981                	li	s3,0
 644:	b55d                	j	4ea <vprintf+0x60>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 686:	e08080e7          	jalr	-504(ra) # 48a <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 6bc:	dd2080e7          	jalr	-558(ra) # 48a <vprintf>
}
...
free(void *ap)
{
 ...
 6d6:	92e78793          	addi	a5,a5,-1746 # 1000 <freep>
 6da:	639c                	ld	a5,0(a5)
 6dc:	a805                	j	70c <free+0x44>
 ...
 6fc:	e398                	sd	a4,0(a5)
 6fe:	a099                	j	744 <free+0x7c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 700:	6398                	ld	a4,0(a5)
 702:	00e7e463          	bltu	a5,a4,70a <free+0x42>
 706:	00e6ea63          	bltu	a3,a4,71a <free+0x52>
{
 70a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 70c:	fed7fae3          	bleu	a3,a5,700 <free+0x38>
 710:	6398                	ld	a4,0(a5)
 712:	00e6e463          	bltu	a3,a4,71a <free+0x52>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 716:	fee7eae3          	bltu	a5,a4,70a <free+0x42>
  if(bp + bp->s.size == p->s.ptr){
 ...
 72a:	fae60ae3          	beq	a2,a4,6de <free+0x16>
    bp->s.ptr = p->s.ptr;
 ...
 73e:	fae689e3          	beq	a3,a4,6f0 <free+0x28>
  } else
    p->s.ptr = bp;
 742:	e394                	sd	a3,0(a5)
  freep = p;
...
malloc(uint nbytes)
{
 ...
 776:	0009891b          	sext.w	s2,s3
  if((prevp = freep) == 0){
 77a:	00001797          	auipc	a5,0x1
 77e:	88678793          	addi	a5,a5,-1914 # 1000 <freep>
 782:	6388                	ld	a0,0(a5)
 784:	c515                	beqz	a0,7b0 <malloc+0x5e>
 ...
 786:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 788:	4798                	lw	a4,8(a5)
 78a:	03277f63          	bleu	s2,a4,7c8 <malloc+0x76>
 78e:	8a4e                	mv	s4,s3
 790:	0009871b          	sext.w	a4,s3
 794:	6685                	lui	a3,0x1
 796:	00d77363          	bleu	a3,a4,79c <malloc+0x4a>
 79a:	6a05                	lui	s4,0x1
 79c:	000a0a9b          	sext.w	s5,s4
 ...
 7c2:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
 7c6:	b7e1                	j	78e <malloc+0x3c>
      if(p->s.size == nunits)
 7c8:	02e90b63          	beq	s2,a4,7fe <malloc+0xac>
        p->s.size -= nunits;
 ...
 802:	bff1                	j	7de <malloc+0x8c>
  hp->s.size = nu;
 804:	01552423          	sw	s5,8(a0)
  free((void*)(hp + 1));
 808:	0541                	addi	a0,a0,16
 80a:	00000097          	auipc	ra,0x0
 80e:	ebe080e7          	jalr	-322(ra) # 6c8 <free>
  return freep;
 812:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
 814:	d979                	beqz	a0,7ea <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 816:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 818:	4798                	lw	a4,8(a5)
 81a:	fb2777e3          	bleu	s2,a4,7c8 <malloc+0x76>
    if(p == freep)
 81e:	6098                	ld	a4,0(s1)
 820:	853e                	mv	a0,a5
 822:	fef71ae3          	bne	a4,a5,816 <malloc+0xc4>
  p = sbrk(nu * sizeof(Header));
 826:	8552                	mv	a0,s4
 828:	00000097          	auipc	ra,0x0
 82c:	b6a080e7          	jalr	-1174(ra) # 392 <sbrk>
  if(p == (char*)-1)
 830:	fd651ae3          	bne	a0,s6,804 <malloc+0xb2>
        return 0;
 834:	4501                	li	a0,0
 836:	bf55                	j	7ea <malloc+0x98>
