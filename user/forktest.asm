...
forktest(void)
{
  ...
  3e:	43e50513          	addi	a0,a0,1086 # 478 <sysinfo+0x8>
  ...
  68:	42450513          	addi	a0,a0,1060 # 488 <sysinfo+0x18>
  ...
  b8:	42450513          	addi	a0,a0,1060 # 4d8 <sysinfo+0x68>
  ...
  d4:	3d850513          	addi	a0,a0,984 # 4a8 <sysinfo+0x38>
  ...
  ee:	3d650513          	addi	a0,a0,982 # 4c0 <sysinfo+0x50>
...
gets(char *buf, int max)
{
 ...
 228:	0344d863          	ble	s4,s1,258 <gets+0x56>
    cc = read(0, &c, 1);
 22c:	4605                	li	a2,1
...
atoi(const char *s)
{
 ...
 2f8:	fee5f1e3          	bleu	a4,a1,2da <atoi+0x1e>
  return n;
}
 2fc:	6422                	ld	s0,8(sp)
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 30a:	0800                	addi	s0,sp,16
  ...
  src = vsrc;
  if (src > dst) {
 30c:	02b57663          	bleu	a1,a0,338 <memmove+0x32>
    while(n-- > 0)
