...
main(void)
{
  ...
  12:	8c250513          	addi	a0,a0,-1854 # 8d0 <malloc+0xe6>
  ...
  3a:	8a290913          	addi	s2,s2,-1886 # 8d8 <malloc+0xee>
  3e:	854a                	mv	a0,s2
  ...
  6e:	8be50513          	addi	a0,a0,-1858 # 928 <malloc+0x13e>
  ...
  8c:	84850513          	addi	a0,a0,-1976 # 8d0 <malloc+0xe6>
  90:	00000097          	auipc	ra,0x0
  94:	35a080e7          	jalr	858(ra) # 3ea <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	83650513          	addi	a0,a0,-1994 # 8d0 <malloc+0xe6>
  a2:	00000097          	auipc	ra,0x0
  a6:	340080e7          	jalr	832(ra) # 3e2 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	84450513          	addi	a0,a0,-1980 # 8f0 <malloc+0x106>
  b4:	00000097          	auipc	ra,0x0
  b8:	676080e7          	jalr	1654(ra) # 72a <printf>
      exit(1);
  bc:	4505                	li	a0,1
  ...
  d2:	83a50513          	addi	a0,a0,-1990 # 908 <malloc+0x11e>
  d6:	00000097          	auipc	ra,0x0
  da:	304080e7          	jalr	772(ra) # 3da <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	83250513          	addi	a0,a0,-1998 # 910 <malloc+0x126>
  e6:	00000097          	auipc	ra,0x0
  ea:	644080e7          	jalr	1604(ra) # 72a <printf>
      exit(1);
  ee:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 498:	4b488893          	addi	a7,a7,1204 # 948 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 56a:	3e2b8b93          	addi	s7,s7,994 # 948 <digits>
 ...
 6a6:	2be48493          	addi	s1,s1,702 # 960 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 76e:	8a678793          	addi	a5,a5,-1882 # 1010 <freep>
 772:	639c                	ld	a5,0(a5)
...
malloc(uint nbytes)
{
 ...
 816:	7fe78793          	addi	a5,a5,2046 # 1010 <freep>
 81a:	6388                	ld	a0,0(a5)
 ...
 840:	7d448493          	addi	s1,s1,2004 # 1010 <freep>
  if(p == (char*)-1)
 844:	5b7d                	li	s6,-1
 ...
 87a:	78a73d23          	sd	a0,1946(a4) # 1010 <freep>
      return (void*)(p + 1);
